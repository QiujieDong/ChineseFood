...
def load_model(weights_path, shape):
   model_final = create_model(10, 0, shape)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Food 10 Program')
    ...
    parser.add_argument('-p', help='path of the saved model', dest='model_path',
                        type=str, default='./saved_models_ChineseFood/food-10-epoch-01.hdf5')
    ...
    if args.mode == 'train':
        ...
        # add a callback
        callbacks.append(ModelCheckpoint(filepath='./saved_models_ChineseFood/weights.epoch-{epoch:02d}-val_loss-{val_loss:.2f}.hdf5',
        ...
        classes = get_classes('./ChineseFood/meta/classes1.txt')
